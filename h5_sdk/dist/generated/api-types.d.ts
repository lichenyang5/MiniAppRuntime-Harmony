...
export type TypedBridgeResponse<T extends ApiAction> = Omit<BridgeResponse, 'data'> & {
    data?: ApiResponseDataMap[T];
};
export type TypedSendArgs<T extends ApiAction> = ApiParamsMap[T] extends undefined ? [params?: undefined, options?: MyASCFSendOptions] : [params: ApiParamsMap[T], options?: MyASCFSendOptions];
