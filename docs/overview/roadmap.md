...
当前项目用于开源学习和工程实践，不宣称实现完整小程序规范，也不宣称已达到生产 SDK 的安全、兼容性和发布要求。H5 SDK 已完成公开 scoped 包配置、双产物、pack 和本地 consumer 验证，但没有执行 npm publish；registry 安装与真机 Demo 仍待发布后验证。
